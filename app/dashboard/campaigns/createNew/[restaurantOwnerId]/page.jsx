...
const Page = ({ params }) => {
  ...
  const handleFinalSubmit = () => {
    ...
    .then((data) => {
      ...
      router.push(`/dashboard/campaign/${data._id}`);
    })
  ...
  const uploadMenu = (file) => {
    ...
    console.log(file);
    const media = 'https://animaljustice.ca/wp-content/uploads/2021/08/Press-Release-McDonalds-Sustainable-Ad-Animal-Justice.jpeg';
